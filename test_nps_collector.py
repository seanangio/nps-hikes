...
class TestNPSDataCollector:
    ...
    def test_validate_coordinates_invalid_format(self, collector):
        ...
        lat, lon = collector._validate_coordinates("not_a_number", "-115.1777", "Test Park")
        assert lat is None
        assert lon is None
    ...
    def test_find_best_park_match_exact_match(self, collector):
        ...
        mock_results = [
            {'fullName': 'Zion National Park', 'parkCode': 'zion', 'relevanceScore': 80},
    ...
    def test_find_best_park_match_relevance_fallback(self, collector):
        ...
        mock_results = [
            ...
            {'fullName': 'Lower Relevance Park', 'parkCode': 'lower', 'relevanceScore': 80}
        ]
