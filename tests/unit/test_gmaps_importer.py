...
<kml xmlns="http://www.opengis.net/kml/2.2">
  <Document>
    ...
    def test_validate_location_valid_coords(self):
        ...
        mock_nps_collector._validate_coordinates.return_value = (36.4871085, -121.2047223)
    ...
    def test_create_csv_artifact(self):
        ...
        assert len(df) == 2
        assert list(df.columns) == ['id', 'park_code', 'location_name', 'latitude', 'longitude', 'created_at']
    ...
    def test_import_park_locations_database_mode(self):
        ...
        with patch.object(self.importer, '_park_exists_in_parks_table', return_value=True):
            locations = [
                {
                    'park_code': 'pinn',
                    'location_name': 'Juniper Canyon Trail',
