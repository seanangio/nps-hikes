...
SELECT
    ...
    CASE
        WHEN COALESCE(SUM(o.length_miles), 0) > 0
        THEN ROUND((COALESCE(SUM(t.length_miles), 0)::numeric / COALESCE(SUM(o.length_miles), 0)::numeric), 3)
        ELSE NULL
    END as length_ratio,
    CASE
        WHEN COALESCE(AVG(o.length_miles), 0) > 0
        THEN ROUND((COALESCE(AVG(t.length_miles), 0)::numeric / COALESCE(AVG(o.length_miles), 0)::numeric), 3)
        ELSE NULL
