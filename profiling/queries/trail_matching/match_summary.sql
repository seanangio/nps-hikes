...
SELECT 
    ...
    COUNT(CASE WHEN match_status = 'MATCHED' THEN 1 END) as successfully_matched,
    ...
    ROUND(
        (COUNT(CASE WHEN source = 'TNM' THEN 1 END)::float / COUNT(CASE WHEN match_status = 'MATCHED' THEN 1 END) * 100)::numeric, 
        1
